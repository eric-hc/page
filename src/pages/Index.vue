  ...
  <Layout>
    <div class="hero container-inner mx-auto flex flex-col sm:flex-row justify-between py-16">
      <div class="text-4xl font-bold w-full sm:w-3/5 text-center sm:text-left">
        <div class="leading-tight">Eric Carboni</div>
        <div class="text-green-700 leading-tight">Personal page with blog demo</div>
      </div>
    ...
    <div class="overflow-x-hidden">
      <div class="work container-inner mx-auto text-xl border-t border-gray-500 border-b py-16 mb-16 relative">
        <h2 class="font-bold mb-6" id="work">Here are some things I do:</h2>
    ...
    <div class="overflow-x-hidden border-gray-200 border-b">
      <div class="get-to-know-me container-inner mx-auto text-xl pb-16 relative">
        ...
        <div class="responsive-container">
          <iframe class="responsive-iframe w-full h-full top-0 left-0 border-0" src="https://www.youtube.com/embed/C_oACPWGvM4" style="border:0;" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
    ...
    <div class="overflow-x-hidden">
      <div class="contact-me bg-background-secondary pt-16">
        <div class="container-inner mx-auto text-xl pb-4 relative">
          ...
          <p class="mb-12">Drop me a message and I'll get back to you as soon as I can!</p>

          <div class="text-lg sm:text-lg mb-16">
            <form class="mb-12" name="contact"
              method="post"
